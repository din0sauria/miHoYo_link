...
$game_path = ""
$data_path = "D:\Program Files\miHoYo Launcher\games\Genshin Impact Game\YuanShen_Data\webCaches"
...
$webCachesPath = "$game_path/Genshin Impact Game/YuanShen_Data/webCaches"
...
if ($latestVersionPath) {
    ...
    # 如果找不到版本文件夹，使用默认路径（可选）
    $data_path = "$webCachesPath/2.39.0.0/Cache/Cache_Data/data_2"
    Write-Warning "未能找到最新的版本文件夹，使用默认路径"
}

# 同样处理硬编码的路径
$defaultWebCachesPath = "D:\Program Files\miHoYo Launcher\games\Genshin Impact Game\YuanShen_Data\webCaches"
...
if ($latestDefaultVersionPath) {
    ...
    $default_data_path = "D:\Program Files\miHoYo Launcher\games\Genshin Impact Game\YuanShen_Data\webCaches\2.39.0.0\Cache\Cache_Data\data_2"
